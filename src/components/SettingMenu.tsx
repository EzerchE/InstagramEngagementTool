        ...
        <div className='setting-menu'>
          ...
          <div className='settings-module'>
            ...
            <div className='settings-content'>
              <div className='row'>
                <label className='minimun-width'>Time between audit requests</label>
                <input
                  type='number'
                  id='searchCycles'
                  name='searchCycles'
              ...
              <div className='row'>
                <label className='minimun-width'>Cooldown after five audit requests</label>
                <input
                  type='number'
                  id='fiveSearchCycles'
              ...
              <div className='row'>
                <label className='minimun-width'>Time between unfollow actions</label>
                <input
                  type='number'
              ...
              <div className='row'>
                <label className='minimun-width'>Cooldown after five unfollow actions</label>
                <input
                  type='number'
              ...
              <div className='warning-container'>
                <h3 className='warning'><b>Risk note:</b> Aggressive timings can trigger Instagram limits.</h3>
                <h3 className='warning'>Keep action batches small and manual.</h3>
              </div>
            </div>
          </div>
